...
//***************************************************************************************************
//单项复选框操作
$('body').on('click', ' .formCheckbox', function() { 
	if($(this).data('state')==1){
		//去除选中样式
...
//自定义ajax上传文件方法
function fileUploadBody(fileDiv,URLSS,URL){
	//文件上传的最外层div
	...
	fileUploadDivTwoObj.wrap("<form class='"+fileUploadDivFour+"' action='"+URLSS+"/common/action/type/"+fileTyped+"' method='post' enctype='multipart/form-data'></form>"); 

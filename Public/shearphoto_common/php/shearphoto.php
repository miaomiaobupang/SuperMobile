...
/*..........................................................结果输出给JS..............................................................*/	
    ...
    */
	...
	//连接数据库
	session_start();
	//file_put_contents('12.txt', $result[0]["ImgUrl"].'***'.$result[1]["ImgUrl"].'***'.$result[2]["ImgUrl"]);

	//准备当前用户session数据信息
	$user =   $_SESSION['userInfo'];
	//file_put_contents('2.txt',$user['uid']);
	//更换头像
	//$user['headimg'] = '__URL__/Public/shearphoto_common/'.$result[0]['ImgUrl'];
	//更新缓存
	//$_SESSION['userInfo'] = $user;
	
	$data['img']=$result[0]['ImgUrl'];
	$data['uid']=$_SESSION['userInfo']['uid'];
	//$Shear = new ShearPhoto; //类实例开始
	$Shear = new ShearPhoto(); //类实例开始
	$state=$Shear->post('http://'.$_SERVER['HTTP_HOST'].'/index.php/Common/saveImg',$data);
	file_put_contents('1.txt',$state);
	file_put_contents('2.txt',$data['img'].$data['uid'].$_SERVER['HTTP_HOST']);

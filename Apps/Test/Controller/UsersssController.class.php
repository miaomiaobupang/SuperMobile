...
class UserController extends LimitController {
	...
	*/
	public function iptest($ip){
		...
		$header = array(
			'apikey:  284b9dabd1b9def88bfc0f99845029fb',
		);
		// 添加apikey到header
	...
	public function tests(){
		//var_dump(find_visitor_info());
		//var_dump(find_cityname_weatherinfo('郑州'));
		//sendSmsCode("15311462220","【非速搜】您的订单验证码是测试短信，1分钟有效，客服热线400-6688-733");
		//sendMail('11740390@qq.com','我是邮件标题','我是邮件内容');
		
		$types['typefid']=1001101;
		$types['typeid']=100110101;
		$types['title']="用手机15311459996注册";
		//var_dump("123");
		var_dump($this->logM->logAdd($types));
	}
	...
	*/
	public function registerPhoneShow(){
		//var_dump();

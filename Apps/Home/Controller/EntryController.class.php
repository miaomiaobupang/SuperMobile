...
class EntryController extends LimitController {
	...
	public function expertList(){
		$this->display('expertList');
	}
	
	public function uploadFile(){
		dump(C('EBIGIMG'));
		// $state = http_down('http://kol-statics.oss-cn-beijing.aliyuncs.com/editor/1842137a85623b7cae726da2a1349323dfbd3a.jpg',C('EBIGIMG'));
		$state = download('http://kol-statics.oss-cn-beijing.aliyuncs.com/editor/1842137a85623b7cae726da2a1349323dfbd3a.jpg','/Public/Uploads'); 
		echo $state;
	}
